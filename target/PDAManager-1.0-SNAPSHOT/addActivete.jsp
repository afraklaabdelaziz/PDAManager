            ...
            <div class="modal-body">
                <form method="post" name="FormRegister"   class="flex justify-content-center ms-5 me-5 w-75">
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" name="dateD" >
                    </div>
                    <div class="mb-3">
                        <label class="form-label">date fin </label>
                        <input type="datetime-local" class="form-control" name="dateF" >
                    </div>
                    <div class="mb-3">
                        <label  class="form-label">date debut inscription</label>
                        <input type="datetime-local" class="form-control" name="dateDI" >
                    </div>
                    <div class="mb-3">
                        <label class="form-label"> date fin inscription</label>
                        <input type="datetime-local" class="form-control" name="dateFI" >
                    </div>
